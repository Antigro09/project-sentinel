...
def main() -> int:
    ...
    if failed:
        ...
        print("What fails is the SEARCH built on it, and it is a different")
        print("object. X63b finds 10 of 10 and generalises 3 of 10, and its")
        print("section 3b eliminates every cheap explanation: more evidence")
        print("is not monotone (52 -> 56 -> 56 of 100 while it doubles twice,")
        print("two tasks climbing and two collapsing), minimising changes 56")
        print("to 55, and forcing the witness's exact shape still gives 0/10")
        print("on the task it was built for. A correct program exists in the")
        print("shape the search was handed and the search returns a different")
        print("one. FITTING IS NOT IDENTIFYING -- and nothing here can notice")
        print("the question is undetermined. That is X64.")
    else:
